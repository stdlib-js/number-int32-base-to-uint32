...
```javascript
import int32ToUint32 from 'https://cdn.jsdelivr.net/gh/stdlib-js/number-int32-base-to-uint32@v0.1.1-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/number-int32-base-to-uint32/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/number-int32-base-to-uint32/actions/workflows/test.yml?query=branch:v0.1.1
